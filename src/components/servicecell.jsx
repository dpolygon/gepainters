...
const ServiceCell = ({title, subtitle, desc, src, icon: Icon}) => {
  return (
    <div style={{display: 'flex', flexDirection: 'column', overflow: 'hidden', backgroundImage: 'linear-gradient(to bottom, white, lightgrey)', boxShadow: 'inset 0 0 10px 2px white', borderRadius: '19px'}}>
