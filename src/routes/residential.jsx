    ...
    <div>
      <div className="residential-hero-banner" style={{ backgroundImage: `url('/images/samplework/residential.avif')` }}>
        <div style={{ padding: '0 0 6rem 1rem' }}>
          <div style={{ boxShadow: '0 0 80px 75px rgb(0, 0, 0, .5)', backgroundColor: 'rgb(0, 0, 0, .5)', borderRadius: '80px' }}>
      ...
      <div className='service-theme'>
        ...
        <h4 className='multihome-options' style={{ display: 'flex', justifyContent: 'center', color: 'black', textAlign: 'center', margin: '3rem', background: 'rgb(0, 0, 0, .05)', borderRadius: '32px' }}><p style={{ color: 'black', width: '75%' }}>Includes duplexes, fourplexes, apartment units, and rental turnovers—ideal for multi-family or investment properties needing efficient, whole-home painting solutions.</p></h4>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '4rem 0 0 0' }}>
